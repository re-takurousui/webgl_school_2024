...
class App {
  ...
  setupGeometry() {
    ...
    this.position = [
      //後ろ
      0.0,  .8,  0.0, // ひとつ目の頂点の x, y, z 座標
      0.32, 0.4,  0.0, // ふたつ目の頂点の x, y, z 座標
      -0.32, 0.4,  0.0, // みっつ目の頂点の x, y, z 座標

      -0.01,  -.25,  0.0, // ひとつ目の頂点の x, y, z 座標
      -0.3, 0.25,  0.0, // ふたつ目の頂点の x, y, z 座標
      -0.6, -0.2,  0.0, // みっつ目の頂点の x, y, z 座標
      ...
      //下
      0.0,  -0.4,  0.0, // ひとつ目の頂点の x, y, z 座標
      0.32, 0.0,  0.0, // ふたつ目の頂点の x, y, z 座標
      -0.32, 0.0,  0.0, // みっつ目の頂点の x, y, z 座標

      //右上
      0.0,  0.5,  0.0, // ひとつ目の頂点の x, y, z 座標
      0.32, 0.0,  0.0, // ふたつ目の頂点の x, y, z 座標
      0.47, 0.47,  0.0, // みっつ目の頂点の x, y, z 座標

      //左上
      0.0,  .5,  0.0, // ひとつ目の頂点の x, y, z 座標
      -0.47, 0.47,  0.0, // ふたつ目の頂点の x, y, z 座標
      -0.32, 0.0,  0.0, // みっつ目の頂点の x, y, z 座標
    ...
    this.color = [
      //後ろ
      1.0, 1.0, 1.0, 1.0, // ひとつ目の頂点の r, g, b, a カラー赤
      0.0, 0.0, 0.6, 1.0, // ふたつ目の頂点の r, g, b, a カラー緑
      0.0, 0.0, 0.6, 1.0, // みっつ目の頂点の r, g, b, a カラー青

      0.0, 0.0, 0.6, 1.0, // ひとつ目の頂点の r, g, b, a カラー
      0.0, 0.0, 0.6, 1.0, // ふたつ目の頂点の r, g, b, a カラー
      1.0, 1.0, 1.0, 1.0, // みっつ目の頂点の r, g, b, a カラー
      ...
      //下
      1.0, 1.0, 1.0, 1.0, // ひとつ目の頂点の r, g, b, a カラー
      0.0, 0.0, 0.6, 1.0, // ふたつ目の頂点の r, g, b, a カラー
      0.0, 0.0, 0.6, 1.0, // みっつ目の頂点の r, g, b, a カラー
      ...
      //左上
      0.0, 0.0, 0.6, 1.0, // ひとつ目の頂点の r, g, b, a カラー
      1.0, 1.0, 1.0, 1.0, // ふたつ目の頂点の r, g, b, a カラー
      0.0, 0.0, 0.6, 1.0, // みっつ目の頂点の r, g, b, a カラー
      
      //真ん中
      0.0, 0.0, 0.6, 1.0, // ひとつ目の頂点の r, g, b, a カラー赤
      0.0, 0.0, 0.6, 1.0, // ふたつ目の頂点の r, g, b, a カラー緑
      0.0, 0.0, 0.6, 1.0, // みっつ目の頂点の r, g, b, a カラー青
    ];
    // 要素数は RGBA の４つ
  ...
  render() {
    ...
    const nowTime = (Date.now() - this.startTime) * 0.0006;
